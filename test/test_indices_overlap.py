...
def test1(recwarn):
    n_sets, n_items, permute = 0, 0, None
...
def test2(recwarn):
    n_sets, n_items, permute = 0, 1, None
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
    assert bwsindices == []
    assert n_examples == 0
    assert len(recwarn) == 1
...
def test3(recwarn):
    n_sets, n_items, permute = 0, 2, None
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
    assert bwsindices == []
    assert n_examples == 0
    assert len(recwarn) == 1
...
def test4(recwarn):
    n_sets, n_items, permute = 1, 2, None
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
...
def test5():
    n_sets, n_items, permute = 4, 2, False
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
...
def test6():
    n_sets, n_items, permute = 4, 3, False
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
...
def test7():
    n_sets, n_items, permute = 4, 4, False
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
    assert bwsindices == [
...
def test8():
    n_sets, n_items, permute = 4, 5, False
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
    assert bwsindices == [
        [0, 1, 2, 3, 4], [4, 5, 6, 7, 8],
...
def test9():
    n_sets, n_items, permute = 1000, 6, False
    bwsindices, n_examples = indices_overlap(n_sets, n_items, permute)
