...
![Overlapping BWS sets.](/docs/bwsample-overlap.png | width=200)
...
![Connect not overlapped examples to new BWS sets.](/docs/bwsample-twice.png | width=200)
...
![Identify pairs from BWS set, and increment counts in dictionary.](/docs/bwsample-extract.png | width=200)
